...
public interface IMembershipService
{
    ...
    Task<UserTeamMembership?> GetAsync(string userId, string teamId, CancellationToken cancellationToken = default);
    ...
    Task<List<UserTeamMembership>> GetAllAsync(string userId, CancellationToken cancellationToken = default);
}
