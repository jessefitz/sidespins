...
public static class FunctionContextExtensions
{
    ...
    {
        return context.Items.TryGetValue("UserClaims", out var claims) 
            ? (AppClaims)claims 
            : null;
    }
    ...
    {
        return context.Items.TryGetValue("TeamId", out var teamId) 
            ? teamId.ToString() 
            : null;
    }
    ...
    {
        return context.Items.TryGetValue("TeamRole", out var role) 
            ? role.ToString() 
            : null;
    }
    ...
    public static bool IsUserInTeam(this FunctionContext context, string teamId)
    {
        ...
        return !string.IsNullOrEmpty(userTeamId) && userTeamId.Equals(teamId, StringComparison.OrdinalIgnoreCase);
    }
